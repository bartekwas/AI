...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        ...
        if(LOGGING) System.out.println(configuration);
        AlgorithmUtil algorithmUtil = new AlgorithmUtil(configuration, POPULATION_SIZE, ALGORITHM, LOGGING, BACKPACK_ALGORITHM_LOGGING);
